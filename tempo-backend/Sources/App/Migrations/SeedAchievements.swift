...
struct SeedAchievements: AsyncMigration {
    ...
    private static func milestoneAchievements() -> [AchievementDefinition] {
        [
            ...
            .init(id: "ach_all_integrations", name: "Fully Connected", description: "Connect Whoop, HealthKit, and Calendar.", category: "training", tier: "common", xpReward: 50, criteriaType: "integration_count", criteriaThreshold: 3, flavorText: "All systems online."),
